...
<head>
    ...
    {{--DatePickers--}}
    <link rel="stylesheet" href="{{ asset('assets/css/bootstrap-datepicker.min.css') }}" type="text/css"> {{-- Custom App CSS--}}
    <link href=" {{ asset('assets/css/qs.css') }}" rel="stylesheet" type="text/css"> {{-- Core JS files --}}
...
<body class="innerpages body_bg">
    ...
    {{-- @section('page_title', 'Admit Student') --}} {{-- @section('content') --}}
