<header>
    <div class="main_header">
        ...
        @php $tabname=Request::path(); @endphp
            ...
            <div class="row flexRow">
                <div class="col-md-7 hidden-sm hidden-xs">
                    <div class="menuSec">
                        <ul id="menu">
                            ...
                            <li><a href="{{asset('testimonials')}}" @if($tabname=='testimonials' ) class="active" @endif>Testimonials </a></li>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <div class="nav_login">
                        ...
                        <a href="{{ asset('dashboard')  }}" class="btn_pink"> <span> {{ Auth::user()->name }} <i class="fa fa-user" aria-hidden="true"></i></span></a> @else <a href="Javascript:void(0)" class="btn_pink" data-toggle="modal" data-target="#modal1">login</a>@endif
