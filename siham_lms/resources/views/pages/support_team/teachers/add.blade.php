...
@section('content')
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            <h6 class="card-title">Please fill The form Below To Add A New Teacher</h6>
...
{{--                    </div>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Age:</label>
                            <input min="1" type="number" name="age" placeholder="Age" class="form-control"
                                   value="{{ old('age') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input  type="teaching_speciality" name="teaching_speciality" placeholder="teaching_speciality" class="form-control"
