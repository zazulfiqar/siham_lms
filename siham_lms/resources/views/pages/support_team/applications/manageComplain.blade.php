...
@section('page_title', 'Manage Student Complains')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Complain</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
...
{{--                                </td>--}}
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('application.store_complain_response' , Qs::hash($fetch->id)) }}">
                                @csrf
