...
@section('page_title', 'Manage Teacher Evaluation')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Evaluation</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                @if(Qs::userIsTeamSA())
                                                    {{--                                                    Edit--}}
                                                    <a href="{{ route('teacher_evaluation.edit', $c->id) }}"
                                                ...
                                                @if(Qs::userIsSuperAdmin())
                                                    ...
                                                    <form method="post" id="item-delete-{{ $c->id }}"
                                                          action="{{ route('teacher_evaluation.destroy', $c->id) }}"
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('teacher_evaluation.store') }}">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Question <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input name="question" value="{{ old('name') }}" required type="text"
