...
@section('page_title', 'Manage Teacher Updates')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Updates  </h6>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                @if(Qs::userIsTeamSA())
                                                    {{--                                                    Edit--}}
                                                    <a href="{{ route('teacher_updates.edit', $c->id) }}"
                                                ...
                                                @if(Qs::userIsTeamSA())
                                                    ...
                                                    <form method="post" id="item-delete-{{ $c->id }}"
                                                          action="{{ route('teacher_updates.destroy', $c->id) }}"
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('teacher_updates.store') }}">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="title" value="{{ old('name') }}" required type="text"
                                               class="form-control" placeholder="Enter Updates here">
                                    </div>
                                </div>
