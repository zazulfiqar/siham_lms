...
class frontendController extends Controller
{
    ...
    function indexfront()
    {
        ...
        $home_page_videos= frontHpmepageVideo::where('checkWebsite',1)->get();



        return view('frontend.index', compact('getRecordFrontHomeGallery','frontDynamic','subjects', 'blogs',
                'faqs', 'pricing', 'testimonials', 'frontgallery', 'home_header_image','home_page_videos')
        );
    }
...
//            dd($frontblog);
    ...
    {
        $home_page_videos= frontHpmepageVideo::all();
        // dd('Online Tutor');
        return view('frontend.onlineClasses', compact('home_page_videos'));
