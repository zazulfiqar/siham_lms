...
//                </div>';
 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function getTeacherRecord($remove = [])
    {
        $data = ['user_id','name', 'email', 'address', 'gender', 'bg_id',
            'nal_id', 'state_id', 'lga_id','photo','joining_date','speciality'];
    ...
    public static function getTeacherData($remove = [])
    {
        $data = ['user_id','name', 'email', 'address', 'gender', 'bg_id',
            'nal_id', 'state_id', 'lga_id','photo','joining_date','speciality', 'age'];
         return $remove ? array_values(array_diff($data, $remove)) : $data;
    }
    ...
    public static function getTestimonialUploadPath($user_type)
    {
        return 'uploads/' . $user_type ;
    }
