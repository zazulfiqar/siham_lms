...
class MyClassRepo
{
    ...
    {
        $x =  ClassSchedule::find($id);
        return $x;
    }
    public function updateSchedule($data,$id)
    {
        $x =  ClassSchedule::find($id)->update($data);
        return $x;
    }
    public function destroySchedule($id)
    {
        $x =  ClassSchedule::destroy($id);
        return $x;
    }
    ...
    {
        return Courses::orderBy('name', 'asc')->get();
    }
    ...
    {
        return Courses::orderBy('name', 'asc')->where('teacher_id',$id)->get();
    }
}
