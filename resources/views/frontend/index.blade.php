    ...
    <div class="carousel slide" data-ride="carousel" id="myCarousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                @endif
                @if($home_header_image != null)
                       <img alt="img" src="{{url('/siham_lms/storage/app/public/'.$home_header_image	)}}">
                    @endif
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="slider_text">
                                    <div class="banner_text">
                                        ...
                                        <img src="{{asset('images/logo_white.png')}}" alt="img" class="wow bounceInLeft"
                                             data-wow-delay="0.4s" data-wow-duration="2s">
                                        <h2 data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                            {{ $frontDynami->banner_text }}
                        @endforeach
                                        <ul>
                                            <li data-aos="fade-left" data-aos-delay="400"><a
                                                    href="{{asset('register')}}">Join Us</a></li>
        ...
        <div class="row">
            <div class="col-md-10 col-sm-10 col-xs-12 center">
                <div class="startLearning_head wow bounceInDown" data-wow-delay="0.6s" data-wow-duration="2s">
                    <h2 data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->subjects_topic }}
                        @endforeach
                    </h2>
                    <p data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->subjects_text }}
                        @endforeach
                    </p>
                    ...
                    <div class="learning_slider">
                            ...
                            <div class="learnBox" data-aos="fade-up" data-aos-delay="700">
                                ...
                                <div class="learnBoxText">
                                    <a data-fancybox="gallery"
                                       href="https://www.youtube.com/embed/nWwpyclIEu4">Physics<img
                                            src="{{asset('images/paly-icon.png')}}" alt="img"></a>
                                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="learnBox" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="learnBoxText">
                                    <a data-fancybox="gallery"
                                       href="https://www.youtube.com/embed/nWwpyclIEu4">Finacce<img
                                            src="{{asset('images/paly-icon.png')}}" alt="img"></a>
                                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque</h5>
                                </div>
                            </div>
                    ...
                    <div class="learning_slider">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="learnBox" data-aos="fade-up" data-aos-delay="800">
                                ...
                                <div class="learnBoxText">
                                    <a data-fancybox="gallery"
                                       href="https://www.youtube.com/embed/nWwpyclIEu4">English<img
                                            src="{{asset('images/paly-icon.png')}}" alt="img"></a>
                                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="learnBox" data-aos="fade-up" data-aos-delay="700">
                                ...
                                <div class="learnBoxText">
                                    <a data-fancybox="gallery"
                                       href="https://www.youtube.com/embed/nWwpyclIEu4">History<img
                                            src="{{asset('images/paly-icon.png')}}" alt="img"></a>
                                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="learnBox" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="learnBoxText">
                                    <a data-fancybox="gallery"
                                       href="https://www.youtube.com/embed/nWwpyclIEu4">Biology<img
                                            src="{{asset('images/paly-icon.png')}}" alt="img"></a>
                                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque</h5>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="learnBox" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="learnBoxText">
                                    <a data-fancybox="gallery"
                                       href="https://www.youtube.com/embed/nWwpyclIEu4">Zoology<img
                                            src="{{asset('images/paly-icon.png')}}" alt="img"></a>
                                    <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque</h5>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-md-10 col-sm-10 col-xs-12 center">
                <div class="startLearning_head">
                    <h2 data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_topic }}
                        @endforeach
                    </h2>
                    <p data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_text }}
                        @endforeach
                    </p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="WatchAnyTime_Box" data-aos="flip-left" data-aos-delay="300">
                    ...
                    <h4>
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_card_topic1 }}
                        @endforeach
                    </h4>
                    <p>
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_card_text1 }}
                        @endforeach
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="WatchAnyTime_Box" data-aos="flip-left" data-aos-delay="400">
                    ...
                    <h4>
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_card_topic2 }}
                        @endforeach
                    </h4>
                    <p>
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_card_text2 }}
                        @endforeach
                    </p>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="WatchAnyTime_Box" data-aos="flip-left" data-aos-delay="500">
                    ...
                    <h4>
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_card_topic3 }}
                        @endforeach
                    </h4>
                    <p>
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->learn_anywhere_card_text3 }}
                        @endforeach
                    </p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12 center">
                <div class="startLearning_head">
                    <h2 data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->faq_topic }}
                        @endforeach</h2>
                    <p data-aos="fade-down">
                        @foreach($frontDynamic as $frontDynami )
                        {{ $frontDynami->faq_content }}
                        @endforeach
                    </h2>
                    </p>
                </div>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion"
                                           href="#{{$index+1}}" aria-expanded="true" aria-controls="collapseOne">
                                            {{$faq->faq}}?
                                        </a>
                                    </h4>
                                </div>
                                <div id="{{$index+1}}" class="panel-collapse collapse in" role="tabpanel"
