...
@section('page_title', 'Manage Student Instructions')
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                @if(Qs::userIsTeamSA())
                                                    {{--                                                    Edit--}}
                                                    <a href="{{ route('std_ins.edit', $c->id) }}"
                                                ...
                                                @if(Qs::userIsTeamSA())
                                                    ...
                                                    <form method="post" id="item-delete-{{ $c->id }}"
                                                          action="{{ route('std_ins.destroy', $c->id) }}"
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('std_ins.store') }}">
                                @csrf
