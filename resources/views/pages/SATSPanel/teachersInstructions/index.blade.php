...
@section('page_title', 'Manage Teacher Instructions')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Instruction : How to use portal </h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="all-classes">
                    <table class="table datatable-button-html5-columns">
                        ...
                        <tbody>
                        @foreach($teacher_instructions as $c)
                            <tr>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                @if(Qs::userIsTeamSA())
                                                    {{--                                                    Edit--}}
                                                    <a href="{{ route('teacher_ins.edit', $c->id) }}"
                                                ...
                                                @if(Qs::userIsTeamSA())
                                                    ...
                                                    <form method="post" id="item-delete-{{ $c->id }}"
                                                          action="{{ route('teacher_ins.destroy', $c->id) }}"
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('teacher_ins.store') }}">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="title" value="{{ old('name') }}" required type="text"
                                               class="form-control" placeholder="Enter Instruction here">
                                    </div>
                                </div>
