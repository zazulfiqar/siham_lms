...
@section('page_title', 'Teacher Policies')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Teacher Policies</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-classes" class="nav-link active" data-toggle="tab">RULES AND REGULATIONS FOR TEACHER
                      </a></li>
                ...
                <div class="tab-pane fade" id="new-class">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {{--                                <span>When a class is created, a Section will be automatically created for the class, you can edit it or add more sections to the class at <a target="_blank" href="{{ route('sections.index') }}">Teacher Sections</a></span>--}}
                            {{--                            </div>--}}
                        </div>
                    </div>
