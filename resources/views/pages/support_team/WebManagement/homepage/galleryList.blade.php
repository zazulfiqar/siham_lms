...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header header-elements-inline">
            ...
            <a href="{{ route('homepagegallery.create') }}" class="btn btn-success">Add </a>
            {!! Qs::getPanelOptions() !!}
        </div>
                    ...
                    <table class="table datatable-button-html5-columns">
                        ...
                        @foreach($getRecordFrontHomeGallery as $getRecordFront)
                            <tr>
                                ...
                                <td><img src="{{ URL::asset('uploadsGalleryImage/'.$getRecordFront->photo) }}" width="50" height="50"></td>
                                {{--                                <td>{{ $teach->adm_no }}</td>--}}
                                {{--                                <td>{{ $my_class->name.' '.$teach->section->name }}</td>--}}
                                <td> <a href="{{ route('homepagegallery.edit',  $getRecordFront->id) }}"
                                    class="dropdown-item"> Edit</a>




                                    <form class="" method="post" action="{{ route('homepagegallery.destroy', $getRecordFront->id) }}" enctype="multipart/form-data">
                                        @csrf @method('DELETE')
