...
{{--        </div>--}}
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
{{--                    {{$Faq->id}}--}}
                    <form class="" method="post" action="{{ route('frontfaq.update', $faq->id) }}">
                        @csrf @method('PUT')
...
{{--                             course name  --}}
                            <div class="col-lg-9">
                                <textarea id=""  name="faq" required rows="4" cols="120">{{ $faq->faq }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea id=""   name="description" rows="4" cols="120">{{ $faq->description }}</textarea>
