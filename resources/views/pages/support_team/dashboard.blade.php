                ...
                <div class="card-body cardborderset">
                    <section class="page-contain">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a href="#" class="data-card" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="mb-3" >
                ...
                <div class="card-body text-primary cardborderset">
                    <div id="accordion">
                    @foreach($teacher_updates as $key =>$tu)
                        <div class="card">
