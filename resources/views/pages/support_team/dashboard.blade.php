                ...
                <div class="card flex-row flex-wrap">
                    ...
                    @foreach ($schedule as $s)
                        ...
                        <div class="schedule">
                            ...
                            <div class="link_zoom"><a target="_blank" href="{{ $s->zoom_link }}">{{ $s->zoom_link }}
                                </a></div>
                                    ...
                                    <div class="col-md-6">
                                        <a href="#" class="data-card">
                                            ...
                                            <form class="" method="post"
                                                action="{{ route('students.courcestudentDetails') }}"
                    ...
                    <div class="card flex-row flex-wrap">
                        ...
                        <div id="accordion">
                            ...
                            @foreach ($assignmentsget as $index => $assignment)
                                ...
                                <div class="card-header card-footer w-100 text-muted" id="headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link" data-toggle="collapse"
                                            data-target="#index{{ $index + 1 }}" aria-expanded="true"
                                ...
                                <div id="index{{ $index + 1 }}" class="collapse show" aria-labelledby="headingOne"
