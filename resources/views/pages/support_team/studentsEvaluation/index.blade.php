...
@section('page_title', 'Manage Student Evaluation')
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                @if(Qs::userIsTeamSA())
                                                    {{--                                                    Edit--}}
                                                    <a href="{{ route('student_evaluation.edit', $c->id) }}"
                                                ...
                                                @if(Qs::userIsSuperAdmin())
                                                    ...
                                                    <form method="post" id="item-delete-{{ $c->id }}"
                                                          action="{{ route('student_evaluation.destroy', $c->id) }}"
                ...
                <div class="tab-pane fade" id="new-class">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('student_evaluation.store') }}">
                                @csrf
