        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div class="tab-pane show  active fade" id="new-course">
                    <div class="row">
                        <div class="col-md-6">
                            <form class="" method="post" action="{{ route('teacher.lecture.update',Qs::hash($lecture->id)) }}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Course" class="form-control select"
                                            ...
                                            @foreach($courses as $c)
                                                <option
                                                    {{ $lecture->course_id == $c->id ? 'selected' : '' }} value="{{ $c->id }}">{{ $c->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Class" class="form-control select"
                                            ...
                                            @foreach($my_classes as $c)
                                                <option
                                                    {{ $lecture->class_id == $c->id ? 'selected' : '' }} value="{{ $c->id }}">{{ $c->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Teacher" class="form-control select"
                                            ...
                                            @foreach($teachers as $t)
                                                <option
                                                    {{ $lecture->teacher_id == $t->user_id ? 'selected' : '' }} value="{{ $t->user_id }}">{{ $t->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="file" name="file" value="{{ $lecture->file }}" required type="text"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-lg-3 col-form-label font-weight-semibold">Topic
                                        <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input id="code" name="topic" value="{{ $lecture->topic }}" required type="text"
                                               class="form-control" placeholder="Course Topic">
                                    </div>
                                </div>
