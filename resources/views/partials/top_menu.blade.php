        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
                    ...
                    <img style="width: 38px; height:38px;" src="{{url('/siham_lms/storage/app/public/'.Auth::user()->photo	)}}" class="rounded-circle" alt="photo">
                    @endif
...
{{--                     check and un comment this in future --}}
