    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Administrative">
                            ...
                            @if(Qs::userIsTeamAccount())
                                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['payments.index', 'payments.create', 'payments.edit', 'payments.manage', 'payments.show', 'payments.invoice']) ? 'nav-item-expanded' : '' }}">
                                    ...
                                    <a href="#"
                                       class="nav-link {{ in_array(Route::currentRouteName(), ['payments.index', 'payments.edit', 'payments.create', 'payments.manage', 'payments.show', 'payments.invoice']) ? 'active' : '' }}"><i
                                    ...
                                    <ul class="nav nav-group-sub">
                                        <li class="nav-item"><a href="{{ route('payments.create') }}"
                                                ...
                                                <i class="fa fa-money" aria-hidden="true"></i>Create
                                                Payment</a></li>
                                ...
                                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['students.create', 'students.list', 'students.edit', 'students.show', 'students.promotion', 'students.promotion_manage', 'students.graduated']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                                    ...
                                    <ul class="nav nav-group-sub" data-submenu-title="Students">
                                        <li class="nav-item">
                                            ...
                                            <a href="{{ route('status.inactive_students') }}"
                                               class="nav-link {{ (Route::is('status.inactive_students')) ? 'active' : '' }}">
                                                <i class="fa fa-ban"></i>Inactive Student</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('status.active_students') }}"
                                               class="nav-link {{ (Route::is('status.active_students')) ? 'active' : '' }}">
                            ...
                            @if(Qs::userIsTeamSA())
                                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['students.create', 'students.list', 'students.edit', 'students.show', 'students.promotion', 'students.promotion_manage', 'students.graduated']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                                    ...
                                    <ul class="nav nav-group-sub" data-submenu-title="Manage Teachers">
                                        <!--<li class="nav-item">-->
                                          <a href="{{ route('status.inactive_teachers') }}"
                                         class="nav-link {{ (Route::is('status.inactive_teachers')) ? 'active' : '' }}">
                                          <i class="fa fa-ban"></i>Inactive Teacher</a>
                                        <!--</li>-->
                                        <li class="nav-item">
                                            <a href="{{ route('status.active_teachers') }}"
                                               class="nav-link {{ (Route::is('status.active_teachers')) ? 'active' : '' }}">
                                                <i class="fa fa-check"></i>Active Teacher</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('teachers.create') }}"
                                               class="nav-link {{ (Route::is('teachers.create')) ? 'active' : '' }}">
                    ...
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['students.create', 'students.list', 'students.edit', 'students.show', 'students.promotion', 'students.promotion_manage', 'students.graduated']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['students.list', 'students.edit', 'students.show']) ? 'nav-item-expanded' : '' }}">
                                <a href="#"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.list', 'students.edit', 'students.show']) ? 'active' : '' }}">
                            ...
                            @if(Qs::userIsTeamSA())
                                ...
                                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['teachers.list', 'teachers.edit', 'teachers.show']) ? 'nav-item-expanded' : '' }}">
                                    <a href="#"
                                       class="nav-link {{ in_array(Route::currentRouteName(), ['teachers.list', 'teachers.edit', 'teachers.show']) ? 'active' : '' }}">
                ...
                {{--                        <a href="#" class="nav-link"><i class="fa fa-pencil-square"></i> <span> Exams</span></a>--}}
                ...
                {{--                                        <i class="fa fa-list-alt" aria-hidden="true"></i>Exam List</a>--}}
                {{--                                </li>--}}
                ...
                {{--                                       class="nav-link {{ in_array(Route::currentRouteName(), ['marks.index']) ? 'active' : '' }}">--}}
                {{--                                        <i class="fa fa-list-ul" aria-hidden="true"></i>Marks</a>--}}
                {{--                                </li>--}}
                ...
                {{--                                        <i class="fa fa-list-alt" aria-hidden="true"></i>Marksheet</a>--}}
                {{--                                </li>--}}
                ...
                @if(Qs::userIsTeamSA())
                    ...
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['exams.index', 'exams.edit', 'grades.index', 'grades.edit', 'marks.index', 'marks.manage', 'marks.bulk', 'marks.tabulation', 'marks.show', 'marks.batch_fix',]) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Administrative">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('frontcourse.index') }}"
                                       class="nav-link {{ (Route::is('frontcourse.index')) ? 'active' : '' }}">
                                        <i class="fa fa-book"></i> Course</a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{ route('frontpricing.index') }}"
                                       class="nav-link {{ (Route::is('frontpricing.index')) ? 'active' : '' }}">
                                        <i class="fa fa-usd" aria-hidden="true"></i>Pricing</a>
                                </li>

                                <li class="nav-item">
                                    <a href="{{ route('fronttestimonial.index') }}"
                                       class="nav-link {{ (Route::is('fronttestimonial.index')) ? 'active' : '' }}">
                                        <i class="fa fa-quote-left" aria-hidden="true"></i>Testimonial</a>
                                </li>


                                <li class="nav-item">
                                    <a href="{{ route('frontblog.index') }}"
                                       class="nav-link {{ (Route::is('frontblog.index')) ? 'active' : '' }}">
                                        <i class="fa fa-rss-square" aria-hidden="true"></i>Blog</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('frontfaq.index') }}"
                                       class="nav-link {{ (Route::is('frontfaq.index')) ? 'active' : '' }}">
                                        <i class="fa fa-question-circle" aria-hidden="true"></i>Faq</a>
                                </li>


                                <li class="nav-item">
                                    <a href="{{ route('frontgallery.index') }}"
                                       class="nav-link {{ (Route::is('frontgallery.index')) ? 'active' : '' }}">
                    ...
                    {{-- <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('students.general_app') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.general_app']) ?  : '' }}"><i
                                        class="icon-user"></i> <span>General Application</span></a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('students.drop_a_complain') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.drop_a_complain']) ?  : '' }}"><i
                ...
                @if(Qs::userIsTeamSA())
                    <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('students.general_app') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.general_app']) ?  : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('students.drop_a_complain') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.drop_a_complain']) ?  : '' }}">
                    ...
                    <li class="nav-item nav-item-submenu ">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Subjects">
                            <li class="nav-item">
                                <a href="{{ route('student_evaluation.index') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['subjects.index','subjects.edit',]) ? 'active' : '' }}">
                                    <i class="icon-user" aria-hidden="true"></i> <span>Students Evaluation</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('teacher_evaluation.index') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['subjects.index','subjects.edit',]) ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['teachers.list', 'teachers.edit', 'teachers.show']) ? 'nav-item-expanded' : '' }}">
                                ...
                                <ul class="nav nav-group-sub">
                                    ...
                                    <a href="{{ route('std_ins.index') }}"
                                       class="nav-link "><i class="icon-user" aria-hidden="true"></i>Students
                                        Instructions</a>

                                </ul>
                                <ul class="nav nav-group-sub">

                                    <a href="{{ route('teacher_ins.index') }}"
                                       class="nav-link "><i class="icon-user" aria-hidden="true"></i>Teachers
                                        Instructions</a>
                                </ul>
                            </li>
                            ...
                            @if(Qs::userIsTeamSA())
                                ...
                                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['teachers.list', 'teachers.edit', 'teachers.show']) ? 'nav-item-expanded' : '' }}">
                                    ...
                                    <ul class="nav nav-group-sub">
                                        ...
                                        <a href="{{ route('teacher_noti.index') }}"
                                           class="nav-link "><i class="icon-user" aria-hidden="true"></i>Teachers
                                            Notification</a>
                                ...
                                <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['teachers.list', 'teachers.edit', 'teachers.show']) ? 'nav-item-expanded' : '' }}">
                                    ...
                                    <ul class="nav nav-group-sub">
                                        ...
                                        <a href="{{ route('std_updates.index') }}"
                                           class="nav-link "><i class="icon-user" aria-hidden="true"></i>Students Class
                                            Updates</a>

                                    </ul>
                                    <ul class="nav nav-group-sub">

                                        <a href="{{ route('teacher_updates.index') }}"
                                           class="nav-link "><i class="icon-user" aria-hidden="true"></i>Teachers
                                            Updates</a>
                ...
                @if(Qs::userIsTeacher())
                    ...
                    <li class="nav-item">
                        <a href="{{ route('teacher.my_courses') }}"
                           class="nav-link "
                        >
                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('teacher.uploadlecture') }}"
                           class="nav-link "
                        >
                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                    ...
                    <li class="nav-item ">
                        <a href="{{ route('teacher_assignment.index') }}"
                           class="nav-link "
                        >
                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                    ...
                    <li class="nav-item ">
                        <a href="{{ route('teachers.view.survey') }}"
                           class="nav-link "
                        >
                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('teachers.teacer_rules') }}"
                           class="nav-link "
                        >
                            <i class="fa fa-list-alt" aria-hidden="true"></i>
                ...
                @if(Qs::userIsStudent())
                    ...
                    <li class="nav-item">
                        <a href="{{ route('students.class_schedule') }}"
                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.class_schedule']) ?  : '' }}">
                            <i class="fa fa-clock-o" aria-hidden="true"></i> <span>Online Class Schedule</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('students.course_register') }}"
                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.course_register']) ?  : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('students.offered_courses') }}"
                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.offered_courses']) ?  : '' }}">
                            <i class="fa fa-list-alt" aria-hidden="true"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('students.survey') }}"
                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.survey']) ?  : '' }}">
                    ...
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['students.create', 'students.list', 'students.edit', 'students.show', 'students.promotion', 'students.promotion_manage', 'students.graduated']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            {{--                                <a href="{{ route('students.general_app') }}"--}}
                            {{--                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.general_app']) ?  : '' }}"><i--}}
                            {{--                                        class="icon-user"></i> <span>Assignments</span></a>--}}
                            {{--                            </li>--}}
                            ...
                            <li class="nav-item">
                                <a href="{{ route('student.lecture.show') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['student.lecture.show']) ?  : '' }}"><i
                                        class="icon-user"></i> <span>Lectures</span></a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('student_assignment.index') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['student_assignment.index']) ?  : '' }}"><i
                                        class="icon-user"></i> <span>Assignment</span></a>
                            </li>

                            {{--                            <li class="nav-item">--}}
                            {{--                                <a href="{{ route('students.semester_app') }}"--}}
                            {{--                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.semester_app']) ?  : '' }}"><i--}}
                            {{--                                        class="icon-user"></i> <span>Quizes</span></a>--}}
                            {{--                            </li>--}}

                            {{--                            <li class="nav-item">--}}
                            {{--                                <a href="{{ route('students.semester_app') }}"--}}
                            {{--                                   class="nav-link {{ in_array(Route::currentRouteName(), ['students.semester_app']) ?  : '' }}"><i--}}
                            {{--                                        class="icon-user"></i> <span>Exam</span></a>--}}
                            {{--                            </li>--}}
                    ...
                    {{--                    <li class="nav-item">--}}
                    {{--                        <a href="{{ route('students.survey') }}"--}}
                    {{--                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.survey']) ?  : '' }}"><i--}}
                    {{--                                class="fa fa-comments" aria-hidden="true"></i> <span>Chats</span></a>--}}
                    {{--                    </li>--}}
                    ...
                    <li class="nav-item nav-item-submenu">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('individual_students.general_app') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['individual_students.general_app']) ?  : '' }}"><i
                                        class="fa fa-list-alt" aria-hidden="true"></i> <span>General Application</span></a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('individual_students.drop_a_complain') }}"
                                   class="nav-link {{ in_array(Route::currentRouteName(), ['individual_students.drop_a_complain']) ?  : '' }}">
                                    <i class="fa fa-dropbox" aria-hidden="true"></i><span>Drop a Complain</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    {{--                    <li class="nav-item">--}}
                    {{--                        <a href="{{ route('students.curriculum') }}"--}}
                    {{--                           class="nav-link {{ in_array(Route::currentRouteName(), ['students.curriculum']) ?  : '' }}"><i class="fa fa-list-alt" aria-hidden="true"></i> <span>Curriculum</span></a>--}}
                    {{--                    </li>--}}


                    <li class="nav-item">
                        <a href="{{ route('students.student_rules') }}"
                           class="nav-link "
                        >
                            <i class="fa fa-list-alt" aria-hidden="true"></i>
                            <span>Rules And Regulations</span></a>
                ...
                {{--                        <i class="icon-user"></i> <span>Online Class Schedule</span></a>--}}
                {{--                </li>--}}
